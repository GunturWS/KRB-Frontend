          ...
          <div className="max-w-5xl mx-auto bg-white/70 backdrop-blur-lg rounded-3xl shadow-xl p-10 border border-green-100 space-y-12">
            ...
            >
              ...
              <div className="md:col-span-2 relative">
                ...
                />
                <label className="absolute left-4 top-1 text-sm text-gray-500 bg-white px-1 transition-all duration-200 transform scale-90 origin-[0] peer-placeholder-shown:scale-100 peer-placeholder-shown:top-3.5 peer-placeholder-shown:text-gray-400 peer-focus:top-1 peer-focus:scale-90 peer-focus:text-green-700">
                  Tulis Pesan Kamu
                </label>
              </div>
              ...
              <div className="md:col-span-2 flex justify-center">
                <button
                  ...
                  className={`flex items-center gap-2 px-6 py-3 rounded-xl text-white font-semibold transition duration-300 ${
